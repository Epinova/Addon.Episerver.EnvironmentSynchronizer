...
namespace Addon.Episever.EnvironmentSynchronizer.Test.Synchronizers.SiteDefinitions
{
	...
	{
		[Fact]
		public void When_forcelogin_but_accesscontrolentrylist_is_empty_nothing_should_be_done()
		{
			// Arrange
		...
		[Fact]
		public void When_forcelogin_accesscontrolentrylist_contains_only_everyone_it_should_return_an_empty_list()
		{
			// Arrange
			var startPageContentReference = new ContentReference(9);
		...
		[Fact]
		public void When_forcelogin_accesscontrolentrylist_contains_everyone_and_2_other_entries_should_remove_everyone()
		{
			// Arrange
			var startPageContentReference = new ContentReference(9);
		...
		[Fact]
		public void When_forcelogin_accesscontrolentrylist_contains_everyone_and_4_other_entries_it_should_remove_everyone()
		{
			// Arrange
			var startPageContentReference = new ContentReference(9);
		...
		[Fact]
		public void When_forcelogin_accesscontrolentrylist_contains_4_other_entries_it_should_return_a_list_without_everyone()
		{
			// Arrange
			var startPageContentReference = new ContentReference(9);
